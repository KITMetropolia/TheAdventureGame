...
public class DialogueParser : MonoBehaviour {
	...
	List<DialogueLine> lines;  //teksti tallennetaan listaan, jotta ne näkyvöt pelissä tietyssä järjestyksessä

	// Use this for initialization     // Tässä ladataan notepadissa kirjoitettu  txt. tiedosto, joka sisältää pelin dialogin
	void Start () {
